// src/pages/ThanhHinh/BaoCaoTongHopTheoCa.jsx
...
const css = `
  ...
  .print-header { display: flex; justify-content: center; margin-bottom: 10px; }
  .print-header-center { text-align: center; font-size: 13px; line-height: 1.4; font-weight: bold; text-transform: uppercase; }
  .print-title { text-align: center; margin: 10px 0; }
...
function BaoCaoTongHopTheoCa() {
  ...
  const handleSearch = async () => {
    ...
    setLoading(true);
    try {
      console.log(`Searching BaoCaoTongHopTheoCa: idKehoach=${idKehoach}, startShift=${startShift}, endShift=${endShift}, storeId=${storeId}, maMay=${maMay}`);
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Tổng Hợp Theo Ca");
    XLSX.writeFile(wb, "BaoCao_TongHop_TheoCa.xlsx");
        ...
        <div className="report-modal-overlay">
          <div className="report-modal-container">
            <div className="report-modal-header">
              <h3>Xem trước Báo cáo Tổng hợp Sản xuất công đoạn Cắt vải (Theo Ca)</h3>
              <button 
            ...
            <div className="report-modal-body">
              <div className="print-page">
                <div className="print-header">
                  ...
                  <div className="print-header-right" style={{ fontFamily: 'sans-serif', visibility: 'hidden' }}>
                    OR.SX.06/BH01
                  </div>
                </div>

                <div className="print-title">
                  <h2>TỔNG HỢP BÁN CHẾ PHẨM CẮT VẢI SẢN XUẤT</h2>
...
export default BaoCaoTongHopTheoCa;
