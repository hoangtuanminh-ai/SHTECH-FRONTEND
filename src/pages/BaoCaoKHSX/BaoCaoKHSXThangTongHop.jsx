...
import { getBaoCaoKHSXThangTongHop, getStoreListOrth } from '../../api/thanhhinhApi';
...
const BaoCaoKHSXThangTongHop = () => {
  ...
  const handleSearch = async () => {
    console.log(">>> Bắt đầu tìm kiếm Báo cáo KHSX Tháng Tổng Hợp...");
    console.log("Tham số: storeId =", storeId, "| monthlyPlan =", monthlyPlan, "| spare2 =", spare2);
    setLoading(true);
    try {
      const res = await getBaoCaoKHSXThangTongHop(storeId || '%', monthlyPlan || 0, spare2 || '%');
      ...
      console.error("Lỗi khi gọi API getBaoCaoKHSXThangTongHop:", err);
  ...
  const exportToPDF = () => {
    ...
    doc.setFontSize(12);
    doc.text('BÁO CÁO KẾ HOẠCH SẢN XUẤT THÁNG TỔNG HỢP', pageWidth / 2 + 30, 40, { align: 'center' });
    ...
    doc.save(`BaoCao_KHSX_Thang_TongHop_${monthlyPlan || 'All'}_${new Date().toISOString().slice(0,10)}.pdf`);
    ...
    <div className="mes-container">
      ...
      <div className="mes-content">
        ...
        <div className="mes-section">
          <div className="mes-section-title">Thông Tin Tìm Kiếm: Báo Cáo Kế Hoạch Sản Xuất Tháng Tổng Hợp</div>
...
export default BaoCaoKHSXThangTongHop;
